...
@Service
public class ImageStorageService implements IStorageServices {
	
	private final Path storageFolder = Paths.get("D:\\Documents\\Web\\backend\\spring-boot-departmentstore\\src\\main\\resources\\images","category");
